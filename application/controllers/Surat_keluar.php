...
class Surat_keluar extends CI_Controller
{
	...
	{
		$data['get_surat_keluar'] = $this->db->get('tb_surat_keluar')->result_array();
	...
	public function tambah_data()
	{
		...
		if ($this->upload->do_upload('upload_file')) {
			...
			$this->session->set_flashdata('messageAlert', $this->message('success', 'Berhasil tambah surat keluar'));
